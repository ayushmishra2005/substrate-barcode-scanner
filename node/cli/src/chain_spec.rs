...
use barcode_scanner_runtime::{
    ...
    StakingConfig, IndicesConfig, SudoConfig, SystemConfig,
    TechnicalCommitteeConfig, wasm_binary_unwrap
};
use barcode_scanner_runtime::Block;
use barcode_scanner_runtime::constants::currency::*;
...
pub use barcode_scanner_runtime::GenesisConfig;
