...
use barcode_scanner_runtime::RuntimeApi;
use sc_service::{
...
mod tests {
	...
	use barcode_scanner_runtime::{BalancesCall, Call, UncheckedExtrinsic, Address};
	use barcode_scanner_runtime::constants::{currency::CENTS, time::SLOT_DURATION};
	use codec::Encode;
	use sp_core::{
